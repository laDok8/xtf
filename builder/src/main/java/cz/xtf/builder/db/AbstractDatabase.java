...
public abstract class AbstractDatabase extends DefaultStatefulAuxiliary {
  ...
  public DeploymentConfigBuilder configureDeployment(
      ApplicationBuilder appBuilder, boolean synchronous) {
    ...
    if (this.persistentVolClaim != null) {
      builder
          ...
          .addPersistenVolumeClaim(
              this.persistentVolClaim.getName(), this.persistentVolClaim.getClaimName());
      builder
          .podTemplate()
          .container()
          .addVolumeMount(this.persistentVolClaim.getName(), dataDir, false);
    }
