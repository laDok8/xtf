...
public class RoleBindingBuilder extends AbstractBuilder<RoleBinding, RoleBindingBuilder> {
  ...
  /**
   * What <code>kind</code> gains the role defined at roleRef. For example: <code>ServiceAccount
   * </code>
   */
  ...
  /**
   * What is name of the <code>kind</code> that gains the <code>role</code> defined at roleRef. For
   * example account <code>default</code>.
   */
  ...
  /**
   * What is namespace of the defined <code>kind</code>. For example namespace <code>myproject
   * </code>.
   */
  ...
  /**
   * What is <code>kind</code> we want to reference to the subject. For example kind <code>Role
   * </code>.
   */
  ...
  public RoleBinding build() {
    RoleBindingFluent.SubjectsNested<io.fabric8.kubernetes.api.model.rbac.RoleBindingBuilder>
        subject =
    ...
    RoleBindingFluent.RoleRefNested<io.fabric8.kubernetes.api.model.rbac.RoleBindingBuilder>
        roleRef = subject.endSubject().withNewRoleRef().withKind(roleRefKind).withName(roleRefName);
