...
public interface Waiter {
  ...
  /**
   * Sets waiter timeout after which waiters stops waiting. Timeout is logged in case of setting
   * {@link Waiter#logPoint(LogPoint)} to anything else then {@link LogPoint#NONE}
   *
  ...
  /**
   * Sets waiters fail fast function that indicates (returns true) if there is an error state and
   * waiting should not proceed.
   *
  ...
  enum LogPoint {
    ...
    /**
     * Logs start of waiting. Its time and reason in case of {@link LogPoint#START} or {@link
     * LogPoint#BOTH}
     *
    ...
    /**
     * Logs start of waiting using the selected logging <code>{@param level}</code>. Its time and
     * reason in case of {@link LogPoint#START} or {@link LogPoint#BOTH}.
     *
     * @param reason reason of waiting
     * @param millis waiting timeout on condition
    ...
    /**
     * Logs end of waiting using the selected logging <code>{@param level}</code>. Its time and
     * reason in case of {@link LogPoint#END} or {@link LogPoint#BOTH}
     *
     * @param reason reason of waiting
     * @param millis waiting timeout on condition
     */
    ...
    /**
     * Logs end of waiting. Its time and reason in case of {@link LogPoint#END} or {@link
     * LogPoint#BOTH}
     *
     * @param reason reason of waiting
     * @param millis waiting timeout on condition
