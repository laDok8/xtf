...
/**
 * Handler for multiple {@link FailFastCheck} instances. Checks every instance and if one of them
 * fails ({@link FailFastCheck#hasFailed()} returns true) returns {@code true} and provide reason of
 * that check.
 */
