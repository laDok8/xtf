...
/**
 * This enum contains the colors that are used when logging container's log on the console; each
 * container gets a different color in order to visually differentiate containers; the background is
 * also colored in order to differentiate application log from containers log.
 */
