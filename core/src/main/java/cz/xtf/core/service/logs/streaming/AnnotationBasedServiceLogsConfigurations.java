...
/**
 * Implements {@link ServiceLogsSettings} in order to provide the concrete logic to handle SLS
 * configuration based on the {@link ServiceLogsStreaming} annotation.
 */
@Slf4j
