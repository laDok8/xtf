...
/**
 * Mutable version of {@link BinarySourceBuild}. The hash of the app itself is recomputed every time
 * it is needed so the build is rebuilded if hash differs from previous one.
 */
public class MutableBinarySourceBuild extends BinarySourceBuild {
  public MutableBinarySourceBuild(
