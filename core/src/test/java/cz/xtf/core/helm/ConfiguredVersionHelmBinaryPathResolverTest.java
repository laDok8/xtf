...
public class ConfiguredVersionHelmBinaryPathResolverTest {
  ...
  private HelmBinaryPathResolver helmBinaryPathResolver =
  ...
  public void resolveCorrectVersion() {
    ...
    testDownloadedVersion(
        "https://mirror.openshift.com/pub/openshift-v4/clients/helm/3.5.0/helm-"
            + systemType
            + "-amd64.tar.gz",
        "3.5.0");
  }
  ...
  private void testDownloadedVersion(String downloadUrl, String helmVersion) {
    ...
    Path cachedPath = Paths.get(HelmConfig.binaryCachePath(), helmVersion, urlHash, "helm.tar.gz");
