...
/**
 * Test cases that verify the SLS configuration and usage through annotation, i.e. {@link
...
public class AnnotationBasedServiceLogsConfigurationTest {
  ...
  /**
   * Check that the expected configuration exists, based on the test class {@link
   * ServiceLogsStreaming} annotation.
   */
  @Test
  public void testCorrectSlsConfigurationsAreCreated() {
    ...
    // AnnotationBasedServiceLogsConfigurationTest - check by retrieving the one based on per-class
    // criteria (negative)
  ...
  /**
   * Check that SLS configuration attributes are properly mapped when using the {@link
   * ServiceLogsStreaming} annotation as a configuration source.
   */
  @Test
