...
public class ResourcesFilterBuilder<E extends HasMetadata> implements Cloneable {
  ...
  /**
   * Resources until the time will be excluded. Lower priority than {@link
   * ResourcesFilterBuilder#setIncludedAlwaysWindow(ZonedDateTime, ZonedDateTime)}. It the resource
   * is in the {@code always included window} it will be included
   */
  ...
  /**
   * Resources in the window will be always included despite {@link
   * ResourcesFilterBuilder#setExcludedUntil(ZonedDateTime)}.
   */
