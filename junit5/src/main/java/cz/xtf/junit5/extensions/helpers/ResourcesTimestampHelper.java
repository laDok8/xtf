...
public class ResourcesTimestampHelper {
  ...
  static ZonedDateTime creationTime(HasMetadata item) {
    return ZonedDateTime.parse(
        item.getMetadata().getCreationTimestamp(), DateTimeFormatter.ISO_DATE_TIME);
  }
  ...
  public static ZonedDateTime timeOfLastResourceOf(
      OpenShift openShift, Class<? extends HasMetadata> resourceClass) {
