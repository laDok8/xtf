...
class ManagedBuildPrebuilderTest {
    ...
    public void buildFromClassWithoutSkipConditionsIsNotSkipped() {
        Assertions.assertThat(ManagedBuildPrebuilder.shouldSkipBuildsForClass(TestClassTest.class))
                .isFalse();
    }

    @Test
    public void buildFromSkippedClassIsSkipped() {
        Assertions.assertThat(ManagedBuildPrebuilder.shouldSkipBuildsForClass(TestClassSkippedForImageTest.class))
                .isTrue();
    }
    ...
    public void buildFromClassSkippedDueToLowVersionIsSkipped() {
        Assertions.assertThat(
                        ManagedBuildPrebuilder.shouldSkipBuildsForClass(TestClassSkippedForLowerVersionTest.class))
                .isTrue();
    }
    ...
    public void buildFromDisabledClassIsSkipped() {
        Assertions.assertThat(ManagedBuildPrebuilder.shouldSkipBuildsForClass(TestClassDisabledTest.class))
                .isTrue();
    }
    ...
    public void buildFromClassMatchingAllSkipConditionsIsSkipped() {
        Assertions.assertThat(
                        ManagedBuildPrebuilder.shouldSkipBuildsForClass(TestClassSkippedByAllConditionsTest.class))
                .isTrue();
    }
